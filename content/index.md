...
<div class="illustration">🧭 Parcours et ressources 2025</div>

## Nouveaux contenus importés

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.5rem; margin: 2rem 0;">

<div style="background: #fff; padding: 1.25rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: center;">
<h3 style="color: #0f766e; margin-top: 0;">👋 Bienvenue</h3>
<p>Introduction, faits marquants et citations clés</p>
<a href="ressources/bienvenue/accueil.html" style="display: inline-block; padding: 0.5rem 1rem; background: #0f766e; color: white; border-radius: 4px; text-decoration: none;">Découvrir →</a>
</div>

<div style="background: #fff; padding: 1.25rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: center;">
<h3 style="color: #7c3aed; margin-top: 0;">🎓 Première</h3>
<p>Programme et activités par projets</p>
<a href="activites/premiere/programme-premiere.html" style="display: inline-block; padding: 0.5rem 1rem; background: #7c3aed; color: white; border-radius: 4px; text-decoration: none;">Parcourir →</a>
</div>

<div style="background: #fff; padding: 1.25rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: center;">
<h3 style="color: #b45309; margin-top: 0;">🔗 Chaîne info</h3>
<p>Exercices interactifs, quiz et simulations</p>
<a href="ressources/chaine_info/index.html" style="display: inline-block; padding: 0.5rem 1rem; background: #b45309; color: white; border-radius: 4px; text-decoration: none;">Accéder →</a>
</div>

<div style="background: #fff; padding: 1.25rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: center;">
<h3 style="color: #1d4ed8; margin-top: 0;">📎 Ressources</h3>
<p>Documents d'accompagnement et jeux</p>
<a href="ressources/ressources.html" style="display: inline-block; padding: 0.5rem 1rem; background: #1d4ed8; color: white; border-radius: 4px; text-decoration: none;">Ouvrir →</a>
</div>

<div style="background: #fff; padding: 1.25rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: center;">
<h3 style="color: #065f46; margin-top: 0;">🧩 Apprendre</h3>
<p>Mini-activités ludiques et interactives</p>
<a href="ressources/apprendre.html" style="display: inline-block; padding: 0.5rem 1rem; background: #065f46; color: white; border-radius: 4px; text-decoration: none;">Tester →</a>
</div>

<div style="background: #fff; padding: 1.25rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); text-align: center;">
<h3 style="color: #6b7280; margin-top: 0;">🎯 Terminale</h3>
<p>Contenus et exercices terminale (à compléter)</p>
<a href="ressources/terminale/terminale.html" style="display: inline-block; padding: 0.5rem 1rem; background: #6b7280; color: white; border-radius: 4px; text-decoration: none;">Voir →</a>
</div>
